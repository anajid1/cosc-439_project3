...
How to compile and run program: Simply compile ana_TCPClient.java, ana_TCPServer.java, and Cryptography.java using javac in a terminal
    ...
    it assumes the server program is on the localhost at port 20750. -g -n arguments can be provided for the server
    as well which can be used to calculate diffie-hellman key.

*Conclusion*
    Time: 7 hours
    
    Problems Encountered: Converting alphanumeric messages to binary and back.
